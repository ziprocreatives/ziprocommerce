...
class Product(models.Model):
    ...
    shop = models.ForeignKey('shops.Shop', on_delete=models.CASCADE,blank=True, null=True)
            # ... rest of fields

    # Basic Info
    name = models.CharField(max_length=255)
    slug = models.SlugField(max_length=300, blank=True)  # For product URL
    ...
    def get_product_url(self):
        """Returns the relative URL for the product storefront."""
